...
```
There seems to be a positive trend between increasing values of carbohydrate and calories in fruits. One value, Ericales although does not have the highest carbohydrate value does have the highest amount of calories. 
...
```{r}
Rosales_Data %>% select(fat, sugar, carbohydrates, protein) %>% boxplot(main = "Boxplot for different Nutrition Variables", horizontal = T, ylab = "Values per 100g", xlab = "Nutrition Variables", col = c("Green", "Red", "Blue", "Orange"))
```
